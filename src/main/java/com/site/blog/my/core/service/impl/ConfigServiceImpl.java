...
public class ConfigServiceImpl implements ConfigService{
    ...
    public static final String websiteIcon = "/admin/dist/img/favion.png";

    public static final String yourAvatar = "/admin/dist/img/13.png";
    public static final String yourEmail = "634219677@qq.com";
    public static final String yourName = "管老师";

    public static final String footerAbout = "your personal blog. have fun.";
    public static final String footerICP = "浙ICP备 xxxxxx-x号";
    public static final String footerCopyRight = "@2018 管老师";
   ...
   @Override
    ...
    public Map<String, String> getAllConfigs() {
       //获取所有的map并封装为map
        ...
        Map<String, String> configMap = blogConfigs.stream().collect(Collectors.toMap(BlogConfig::getConfigName,
